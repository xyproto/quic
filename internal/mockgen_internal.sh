...
rsync -a $GOPATH/src/github.com/xyproto/quic/* $TEMP_DIR/src/github.com/xyproto/quic/ --exclude example
mv $TEMP_DIR/src/github.com/xyproto/quic/internal $TEMP_DIR/src/github.com/xyproto/quic/internalpackage
